...
@pytest.mark.integration_test
async def test_event_future_engagement(
    test_client: AsyncClient,
    graphql_client: GraphQLClient,
    create_person,
    create_org_unit,
    ...
    # Act
    # This creates events that the integration reacts to
    engagement = await graphql_client.testing__engagement_create(
        input=EngagementCreateInput(
            validity=RAValidityInput(from_=datetime.now() + timedelta(days=4), to=None),  # type: ignore
