...
from os2sync_export.autogenerated_graphql_client.read_user_i_t_accounts import (
    ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementResponseCurrentJobFunction as JobFunction,
)
from os2sync_export.autogenerated_graphql_client.read_user_i_t_accounts import (
...
BASE_ITUSER_RESPONSE = ReadUserITAccountsEmployeesObjectsCurrentItusers(
    ...
    engagement_response=ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementResponse(
        current=ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementResponseCurrent(
...
def test_convert_to_os2sync_extension_job_function(
    ...
    mo_it_user = BASE_ITUSER_RESPONSE.copy()
    mo_it_user.engagement_response = ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementResponse(
        current=ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementResponseCurrent(
            extension_3="Konge",
            org_unit=[BASE_UNIT],
...
def test_convert_and_filter_no_engagement(mock_settings):
    ...
    it_user.engagement_response = None
    os2sync_update, mo_new, os2sync_delete, mo_delete = convert_and_filter(
        settings=mock_settings, it_users=[it_user], fk_org_users=[fk_org_user]
    )
    assert os2sync_update == []
