...
from os2sync_export.autogenerated_graphql_client.find_f_k_itsystem import (
...
TOP_UNIT_UUID = UUID("baccbf9b-d699-4118-a6fe-aeb813631a15")
BASE_UNIT = UnitFieldsCurrent(
    uuid=TOP_UNIT_UUID,
    itusers_response=UnitFieldsCurrentItusersResponse(objects=[]),
    unit_type_response=None,
    unit_level_response=None,
    unit_hierarchy_response=None,
    addresses_response=UnitFieldsCurrentAddressesResponse(objects=[]),
    ancestors=[],
    kles_response=UnitFieldsCurrentKlesResponse(objects=[]),
    managers_response=UnitFieldsCurrentManagersResponse(objects=[]),
    name="Andeby kommune",
    parent_response=None,
)

BASE_ITUSER_RESPONSE = ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrent(
    user_key="test",
    external_id=str(uuid4()),
    email=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEmail(objects=[]),
    ...
    person_response=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentPersonResponse(
        current=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentPersonResponseCurrent(
            ...
            ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponsesObjects(
                current=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponsesObjectsCurrent(
                    job_function_response=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponsesObjectsCurrentJobFunctionResponse(
                        current=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponsesObjectsCurrentJobFunctionResponseCurrent(
                            name="tester"
                        )
                    ),
...
async def test_sync_mo_user_to_fk_no_users(
    ...
    mock_graphql_client.read_user_i_t_accounts.return_value = ReadUserITAccountsPersons(
...
#     mock_graphql_client, mock_settings, os2sync_client
# ):
#     it_users = ReadUserITAccountsPersons(
#         objects=[
#             {
#                 "current": {
#                     "itusers": [
...
#                                             "name": "unitname",
#                                             "ancestors": [
#                                                 # Ensure unit is part of the correct tree
...
#                                         }
#                                     ],
#                                     "job_function": {"name": "open source developer"},
#                                 }
#                             ],
#                         }
#                     ],
...
async def test_sync_mo_user_to_fk_delete_user(
    ...
    it_users = ReadUserITAccountsPersons(
        objects=[
            ReadUserITAccountsPersonsObjects(
                current=ReadUserITAccountsPersonsObjectsCurrent(
                    itusers=ReadUserITAccountsPersonsObjectsCurrentItusers(objects=[]),
                    fk_org_uuids=[
                        ReadUserITAccountsPersonsObjectsCurrentFkOrgUuids(
                            objects=[
                                ReadUserITAccountsPersonsObjectsCurrentFkOrgUuidsObjects(
                                    current=ReadUserITAccountsPersonsObjectsCurrentFkOrgUuidsObjectsCurrent(
                                        uuid=uuid4(),
                                        user_key=str(uuid4()),
                                        external_id=str(uuid4()),
                                    )
    ...
    mock_graphql_client.read_user_i_t_accounts.return_value = it_users
    mock_graphql_client.find_f_k_itsystem.return_value = FindFKItsystemItsystems(
        objects=[FindFKItsystemItsystemsObjects(uuid=uuid4())]
    )
    await sync_mo_user_to_fk_org(
        graphql_client=mock_graphql_client,
        uuid=uuid4(),
...
def test_convert_to_os2sync(mock_settings):
    ...
    mo_it_user.person_response = ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentPersonResponse(
        current=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentPersonResponseCurrent(
            name="Brian", nickname=""
        )
    )
...
def test_convert_to_os2sync_extension_job_function(
    ...
    mo_it_user = BASE_ITUSER_RESPONSE.copy()
    mo_it_user.engagements_responses = ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponses(
        current=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponsesObjects(
            extension_3="Konge",
            org_unit=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponsesObjectsCurrentOrgUnitResponse(
                current=BASE_UNIT,
                job_function=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponsesObjectsCurrentJobFunctionResponse(
                    current=ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponsesObjectsCurrentJobFunctionResponseCurrent(
                        name="Udvikler"
                    )
                ),
...
def test_convert_to_os2sync_engagement_org_unit_uuid(mock_settings):
    ...
    mo_it_user = BASE_ITUSER_RESPONSE.copy()
    org_unit = BASE_UNIT.copy()
    org_unit.itusers_response = UnitFieldsCurrentItusersResponse(
        objects=[
            UnitFieldsCurrentItusersResponseObjects(
                current=UnitFieldsCurrentItusersResponseObjectsCurrent(
                    user_key=str(fk_org_unit_uuid)
                )
            )
        ]
    )
...
def test_convert_and_filter_same_uuid(mock_settings):
    ...
    fk_org_user = ReadUserITAccountsPersonsObjectsCurrentFkOrgUuidsObjectsCurrent(
...
def test_convert_and_filter_no_engagement(mock_settings):
    ...
    it_user.engagements_responses = ReadUserITAccountsPersonsObjectsCurrentItusersObjectsCurrentEngagementsResponses(
        objects=[]
    )
    os2sync_update, mo_new, os2sync_delete, mo_delete = convert_and_filter(
        settings=mock_settings, it_users=[it_user], fk_org_users=[fk_org_user]
...
#                     address_type=AddressFieldsAddressType(uuid=uuid4()),
#                     visibility=None,
#                 )
#             ],
#             [],
...
#                     value="mobile-number",
#                     address_type=AddressFieldsAddressType(uuid=ADDRESS_TYPE_UUID),
#                     visibility=None,
#                 )
#             ],
#             [ADDRESS_TYPE_UUID],
...
#                     value="wrong",
#                     address_type=AddressFieldsAddressType(uuid=ADDRESS_TYPE_UUID),
#                     visibility=AddressFieldsVisibility(scope="SECRET"),
#                 ),
#                 ReadUserITAccountsPersonsObjectsCurrentItusersEmail(
#                     value="correct",
#                     address_type=AddressFieldsAddressType(uuid=ADDRESS_TYPE_UUID),
#                     visibility=AddressFieldsVisibility(scope="PUBLIC"),
#                 ),
#             ],
#             [ADDRESS_TYPE_UUID],
#             "correct",
