...
from os2sync_export.autogenerated_graphql_client.read_user_i_t_accounts import (
    ReadUserITAccountsPersonsObjectsCurrentItusersEngagementJobFunction as JobFunction,
)
from os2sync_export.autogenerated_graphql_client.read_user_i_t_accounts import (
...
BASE_UNIT = ReadUserITAccountsPersonsObjectsCurrentItusersEngagementOrgUnit(
    uuid=TOP_UNIT_UUID,
    itusers=[],
    unit_type=None,
    org_unit_level=None,
...
BASE_ITUSER_RESPONSE = ReadUserITAccountsPersonsObjectsCurrentItusers(
    user_key="test",
...
def test_convert_to_os2sync(mock_settings):
    ...
    mo_it_user.person = [
        ReadUserITAccountsPersonsObjectsCurrentItusersPerson(name="Brian", nickname="")
    ]
...
def test_convert_and_filter_same_uuid(mock_settings):
    ...
    fk_org_user = ReadUserITAccountsPersonsObjectsCurrentFkOrgUuids(
