...
from os2sync_export.autogenerated_graphql_client.read_user_i_t_accounts import (
    ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementsResponsesObjectsCurrentJobFunction as JobFunction,
)
from os2sync_export.autogenerated_graphql_client.read_user_i_t_accounts import (
...
BASE_UNIT = ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementsResponsesObjectsCurrentOrgUnit(
    uuid=TOP_UNIT_UUID,
    itusers=[],
    unit_type=None,
    org_unit_level=None,
