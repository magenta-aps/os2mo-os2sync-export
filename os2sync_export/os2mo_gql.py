...
async def read_fk_users_from_person(
    ...
    list[ReadUserITAccountsPersonsObjectsCurrentFkOrgUuids],
    list[ReadUserITAccountsPersonsObjectsCurrentItusers],
]:
...
def convert_and_filter(
    settings: Settings,
    fk_org_users: list[ReadUserITAccountsPersonsObjectsCurrentFkOrgUuids],
    it_users: list[ReadUserITAccountsPersonsObjectsCurrentItusers],
) -> tuple[
    list[User],
    list[ReadUserITAccountsPersonsObjectsCurrentItusers],
    set[UUID],
...
def choose_public_address(
    candidates: Iterable[ReadUserITAccountsPersonsObjectsCurrentItusersEmail]
    | Iterable[ReadUserITAccountsPersonsObjectsCurrentItusersMobile]
    | Iterable[ReadUserITAccountsPersonsObjectsCurrentItusersLandline],
    priority: list[UUID],
) -> str | None:
    if not candidates:
        return None
...
def convert_to_os2sync(
    settings: Settings,
    it: ReadUserITAccountsPersonsObjectsCurrentItusers,
    uuid: UUID,
) -> User:
