...
class ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnit(BaseModel):
    ...
    addresses: Optional[
        List[
            "ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnitAddresses"
        ]
    ]
...
class ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnitAddresses(
    BaseModel
):
    address_type: "ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnitAddressesAddressType"
    visibility: Optional[
        "ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnitAddressesVisibility"
    ]
    value: str


class ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnitAddressesAddressType(
    BaseModel
):
    name: str


class ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnitAddressesVisibility(
    BaseModel
):
    scope: Optional[str]
...
ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnitAddresses.update_forward_refs()
ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnitAddressesAddressType.update_forward_refs()
ReadUserITAccountsEmployeesObjectsCurrentItusersEngagementOrgUnitAddressesVisibility.update_forward_refs()
