...
class ReadUserItusersObjectsCurrentEngagementOrgUnit(BaseModel):
    ...
    ancestors: List["ReadUserItusersObjectsCurrentEngagementOrgUnitAncestors"]
    org_unit_level: Optional[
        "ReadUserItusersObjectsCurrentEngagementOrgUnitOrgUnitLevel"
    ]
    unit_type: Optional["ReadUserItusersObjectsCurrentEngagementOrgUnitUnitType"]


class ReadUserItusersObjectsCurrentEngagementOrgUnitOrgUnitHierarchyModel(BaseModel):
    user_key: str


class ReadUserItusersObjectsCurrentEngagementOrgUnitAncestors(BaseModel):
    uuid: UUID


class ReadUserItusersObjectsCurrentEngagementOrgUnitOrgUnitLevel(BaseModel):
    uuid: UUID


class ReadUserItusersObjectsCurrentEngagementOrgUnitUnitType(BaseModel):
    uuid: UUID
...
ReadUserItusersObjectsCurrentEngagementOrgUnitOrgUnitHierarchyModel.update_forward_refs()
ReadUserItusersObjectsCurrentEngagementOrgUnitAncestors.update_forward_refs()
ReadUserItusersObjectsCurrentEngagementOrgUnitOrgUnitLevel.update_forward_refs()
ReadUserItusersObjectsCurrentEngagementOrgUnitUnitType.update_forward_refs()
